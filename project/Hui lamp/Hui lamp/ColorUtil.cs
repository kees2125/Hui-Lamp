...
namespace Hui_lamp
{
    ...
    {
        public static Color getColor(Light1 light)
        {
            double hue = ((double)light.getHue() * 360.0f) / 65535.0f;
            double sat = (double)light.getSaturation() / 255.0f;
            double val = (double)light.getBrightness()/ 255.0f;
